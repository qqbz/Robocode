...
/**
 * diese klasse hab ich für den droiden angepasst. ist also nur für den test.
 * 
 * alex
 * 
 *
...
/**
 * SteinbeisserLeader mit Radar
 *
 * @author Lukas Becker, Alex Dercho, Simon Fella
 */
public class SteinbeißerLeaderEdit extends TeamRobot {
    ...
    static Object sought = new Object();
    Rectangle2D rec;
...
//                System.out.println(robots);
                ...
                Logger.getLogger(SteinbeißerLeaderEdit.class.getName()).log(Level.SEVERE, null, ex);
            } // //
//System.out.println("DAS ZIEL"+leader.getTARGET());
            move();
...
//        }
    ...
    public void onScannedRobot(ScannedRobotEvent e) { //updated den Eintrag des gescanten Robots
        ...
        if (isTeammate(scanName)) {
            this.droidName = scanName;
        }
        if (!isTeammate(scanName)) {//soll Droiden nicht in die Liste aufnehmen
...
//       System.out.println("Ziel  "+this.target);
    }
    ...
    public void onRobotDeath(RobotDeathEvent e) {
        ...
        if (isTeammate(e.getName())) {
            System.out.println(e.getName() + " ist tot!");
            soloMode = true;
        }
        if (robots.size() == 2) {
            singleEnemy = true;
    ...
    public void onDeath(DeathEvent e) {
        ...
        //sendet dem Droid seinen Tod und eine letzte Info über alle Roboter
    }
